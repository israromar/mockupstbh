        ...
        return (
            <View style={styles.outerContainer}>
                ...
                <View style={styles.welcomeContainer}>
                    <Text style={styles.titleText}>Access Manager</Text>
                ...
                <View style={styles.container}>
                    <View style={styles.buttonContainer}>
                        ...
                        <Button btnType={'square'} SvgImgSrc={FirstResponder} btnText={'New screen '} btnFlag={'ns'} _onPressButton={this._onPressButton} />
                    </View>
                </View>
            </View>
        );
